    ...
    while (index < bytecode.length) {
        ...
        if (instruction == 19) {
            ...
            try {
                ...
                t1 = interpreter(localScope, t4, stack, constantPool, bytecode, {t: localScope[constantPool[0]], e: e});
                if (t1 > 0) {
                    if (option.r) {
                        return stack.pop()
                    }
